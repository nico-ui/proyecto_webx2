<%-- 
    Document   : nuevoPersonalMedicoE
    Created on : 24 ene 2021, 17:41:47
...
<%@page errorPage="error.jsp?de=nuevoPersonalMedicoE.jsp"%>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body class="body1">
        <div class="contenedor3">
            ...
            <hr>
            <form method="POST" action="PersonalMedicoExternoServlet?accion=registroNuevo">
